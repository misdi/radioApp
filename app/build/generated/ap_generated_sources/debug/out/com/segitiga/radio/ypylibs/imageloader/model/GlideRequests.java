package com.segitiga.radio.ypylibs.imageloader.model;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.segitiga.radio.ypylibs.imageloader.model.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.segitiga.radio.ypylibs.imageloader.model.GlideOptions().apply(toSet));
    }
  }
}
